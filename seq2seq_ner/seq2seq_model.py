...
def seq2seq_model(input_data, 
	...
	# 预处理后的decoder输入
	decoder_input = process_decoder_input(targets, da.target_letter_to_int, batch_size)
	
	# 将状态向量与输入传递给decoder
	training_decoder_output, predicting_decoder_output = decoding_layer(da.target_letter_to_int, 
																	   decoding_embedding_size, 
																	   num_layers, 
																	   rnn_size,
																	   target_sequence_length,
